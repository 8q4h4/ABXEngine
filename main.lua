...
local Drawing = execute(network:add("6e956c817dc5893f59d059b", "https://raw.githubusercontent.com/8q4h4/ABXEngine/main/Drawing.lua"))()
local uielements = execute(network:add("6e956c817dc5893f59d059b", "https://raw.githubusercontent.com/8q4h4/ABXEngine/main/UIElements.lua"))()("How many more funcs lmao smh")
